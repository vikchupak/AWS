...
- **Data lake** — centralized repository for storing large amounts of raw and processed data, commonly using S3.
- **AWS Lake Formation** — provides fine-grained access control and governance for data lake data.
