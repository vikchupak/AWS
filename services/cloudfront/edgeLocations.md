...
- Clients get response from origin via closest edge location
  ...
  - Traffic between Amazon CloudFront edge locations and your origin uses the AWS global backbone network, which is faster and more reliable than the public Internet
