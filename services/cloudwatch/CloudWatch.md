...
### !!!EC2!!! Basic Monitoring vs Detailed Monitoring vs (Unified) CloudWatch Agent
...
| **Load Average**            | ❌                                       | ✅ OS-level                                                                     |
| **Per-process CPU/Threads** | ❌                                       | ✅ Shows RDS child, RDS management, OS processes (top consumers only)           |
| **Swap Usage**              | ❌                                       | ✅ OS-level                                                                     |
| **Database Connections**    | ✅                                       | ❌ (still only in default metrics)                                              |
| **Custom Metrics**          | ❌                                       | ❌                                                                              |
| **Application Logs**        | ❌                                       | ❌                                                                              |
| **Process List**            | ❌                                       | ✅ RDS child / RDS processes / OS processes (max 100, top CPU/memory consumers) |
| **Requires IAM Role**       | ❌                                       | ✅                                                                              |
| **Extra Cost**              | ❌                                       | ✅                                                                              |
