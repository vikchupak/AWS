...
- S3 Standard (Better for frequently accessed important/non-replaceable data)
  ...
  - "Milliseconds" firs byte latency
  - Billed for
    - GB data stored
    - GB transfer OUT
    - 1000 requests
...
- S3 One Zone-IA (Better for infrequent accessed non-important/replaceable data)
  ...
  - Billed for
    - GB data stored (cheaper than S3 Standard-IA)
    - GB transfer OUT (cheaper than S3 Standard-IA)
    - 1000 requests (cheaper than S3 Standard-IA)
    - GB retrival
    - Min duration charge of 30 days
    - Min size/capacity charge of 128KB per object
